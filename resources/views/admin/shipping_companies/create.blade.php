...
@endsection
@section('title', 'اضافة شركة شحن')
@section('page-header')
    <!-- breadcrumb -->
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">شركات الشحن</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">> أضافة شركة شحن جديدة</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <form action="{{route('admin.shipping_companies.store')}}" method="POST">
                        ...
                        <div class="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="cost" id="exampleInputPassword1" value="{{old('cost')}}"
                                >
                                @error('cost')
                                <span class="text-danger">
                                                {{$message}}
                            ...
                            <div class="">
                                <div class="mg-b-20 mg-lg-b-0">
                                    ...
                                    @foreach($countries as $country)
                                        <option
                                            value="{{$country->id}}" {{in_array($country->id,old('country_id',[])) ? 'selected' : ''}}>
                                            {{$country->name}}
                                        </option>
                                        @endforeach
                                        </select>
