...
@endsection
@section('title', 'أضافة لغة')
@section('page-header')
				<!-- breadcrumb -->
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">لغات الموقع</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">> أضافة لغة جديدة</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
								...
								<form action="{{route('admin.languages.store')}}" method="POST" >
									...
									<div class="">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="name" id="exampleInputEmail1" placeholder="مثال العربية" value="{{old('name')}}">
                                            @error('name')
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="abbr" id="exampleInputPassword1" placeholder="مثال ar">
                                            @error('abbr')
                                            <span class="text-danger">
                                                {{$message}}
                                            </span>
